            ...
            <div class="nav-container">
                ...
                <ul class="nav-links" id="navLinks">
                    ...
                    <?php if(isset($_SESSION["tipoUsuario"]) && $_SESSION["tipoUsuario"] == "admin"): ?>
                        <li>
                            <a href="adminConteudo.php" class="nav-link">Editar conteúdo</a>
                        </li>
                    <?php endif; ?>

                    <li>
                        <a href="conteudos.php" class="nav-link">Como montar PC</a>
                    </li>

                    <?php if(isset($_SESSION["idUsuario"])): ?>
                        <li>
                            <a href="#" class="nav-link" onclick="abrirMenuPerfil(); return false;">
                                Perfil
                            </a>
                        </li>
                    <?php else: ?>
                ...
                <div class="modal-editar-conteudo">
                    ...
                    <form action="../controller/actionEditarPerfil.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="foto-preview-area">
                            <img src="../assets/img/<?= $_SESSION["fotoUsuario"] ?>" 
                                class="preview-foto-editar" 
                                id="previewFotoEditar">

                            <label for="fotoUsuarioEditar" class="btn-upload-foto">
                        ...
                        <div class="form-group">
                            <label>Nome</label>
                            <input type="text" name="nomeUsuario" value="<?= $_SESSION['nomeUsuario'] ?>" required>
                        </div>

                        <div class="form-group">
                            <label>E-mail</label>
                            <input type="email" name="emailUsuario" value="<?= $_SESSION['emailUsuario'] ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="senha-box">
                                ...
                                <button type="button"
                                        class="toggle-senha"
                                        data-campo="confirmaSenhaPerfil">
                                    <i class="bi bi-eye"></i>
                                </button>
                            </div>
                        ...
                        <div class="acoes-modal">
                            ...
                            <button type="button" class="btn-cancelar" onclick="fecharEditarPerfil()">
                                Cancelar
                            </button>
                        </div>
